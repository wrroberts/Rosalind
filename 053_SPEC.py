...
# Major issue: the given values aren't as precise as those in the table.
...
# Concatenate to get the desired protein.
print ''.join(prot)
with open('output/053_SPEC_output.txt','w') as output_data:
