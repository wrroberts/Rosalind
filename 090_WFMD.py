...
# m = number of copies of the dominant allele
# g = number of generations
# k = ?

# Determine the probability of a given recessive allele in the first generation.
...
# Determine the probability of a given recessive allele in the 2nd to the k-th generation.
...
prob = sum(p[k-1:])
print prob
with open('output/090_WFMD_output.txt','w') as output_file:
