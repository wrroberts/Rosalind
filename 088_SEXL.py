...
# From Rosalind Problem 065: Counting Disease Carriers that if x = proportion of homozygous recessive, y = proportion heterozygous
...
with open('output/088_SEXL_output.txt','w') as output_data:
